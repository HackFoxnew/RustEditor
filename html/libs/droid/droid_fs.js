...
//  VALORES
//-------------
droid.GetExternalFolder = function () {return this.task("GetExternalFolder")};
droid.GetInternalFolder = function () {return this.task("GetInternalFolder")};
...
//  ANALIZAR
//-------------
// @IsFolder() ~ verificar si es carpeta
droid.IsFolder = function (folder) {
  return this.task("IsFolder$", folder) == "true";
}

// @FolderExists() ~ verifica si la carpeta existe
droid.FolderExists = function (folder) {
  return this.task("FolderExists$", folder) == "true";
}

// @FileExists() ~ verifica si el archivo existe
droid.FileExists = function (file) {
  return this.task("FileExists$", file) == "true";
}
